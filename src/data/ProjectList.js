...
import Image_ANN from "../assets/neural-networks.jpg";
...
const ProjectList = [
  ...
  {
    name: "Neural Network for MPox Diagnosis",
    language: "Python",
    framework_library: "Django, Sklearn, Tensorflow",
    github_link:
      "https://github.com/david-hp-0726/Neural_Network_for_MPox_Diagnosis",
    image: Image_ANN,
  },
  {
    name: "Task Manager",
