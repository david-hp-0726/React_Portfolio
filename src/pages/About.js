    ...
    <div className="home">
      <div className="about">
        ...
        <div className="btn-container">
          <button onClick={() => window.open(Resume)} className="btn">
            <ResumeIcon className="btn-icon" />
            <div className="btn-text">View CV</div>
          </button>
          <button onClick={() => window.open(Linkedin)} className="btn">
            <LinkedInIcon className="btn-icon" />
            <div className="btn-text">LinkedIn</div>
          </button>
          <button onClick={() => window.open(Github)} className="btn">
